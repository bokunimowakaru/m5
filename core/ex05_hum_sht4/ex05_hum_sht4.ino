/*******************************************************************************
Example 5: ESP32 (IoTセンサ) Wi-Fi 温湿度計 SENSIRION製 SHT4x 版
・デジタルI2Cインタフェース搭載センサから取得した温湿度を送信するIoTセンサです。

    使用機材(例)：M5Sack Core + ENV IV Unit
...
void setup(){                                   // 起動時に一度だけ実行する関数
    ...
    M5.Lcd.println("ex.05 M5Stack Temp & Hum (SHT4x)");
...
https://github.com/bokunimowakaru/m5/tree/master/core/ex05_hum
*******************************************************************************/
