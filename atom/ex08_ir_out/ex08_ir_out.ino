/*******************************************************************************
Example 8 : Wi-Fi コンシェルジェ リモコン担当(赤外線リモコン制御) for ESP32
赤外線リモコンに対応した家電機器を制御します。 

ESP32 / ATOM / ATOM Lite + IR Unit に対応
...
#define PIN_IR_IN 32                        // IO0 に IR センサを接続(IR Unit)

#define PIN_IR_OUT 12                       // IO1 に IR LEDを接続(Atom内蔵)
// IR Unitの赤外線LEDを使用する場合は PIN_IR_OUT を26に設定してください。
// #define PIN_IR_OUT 26                    // IO1 に IR LEDを接続(IR Unit)
